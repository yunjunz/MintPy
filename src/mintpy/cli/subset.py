...
EXAMPLE = """example:
  ...
  subset.py geometryRadar.h5 slcStack.h5   --lookup geometryRadar.h5 --lat 25.894 25.896 --lon -80.124 -80.122
  subset.py timeseries.h5 geometryRadar.h5 --lookup geometryRadar.h5 --lat 30.50 30.52   --lon 120.30 120.32
"""
